...
class GroupSplit():
    def process(self, df_original, splits, group_column= None, out_column='partition', seed=1234):
...
class LeaveOneOut():
    def process(self, data, group_col):
...
class Split():
    def process(self, data, ratios, seed = 1234, stratified = None, split_col = None, group_outputs = None, lists = None, list_field = None, group = None ):
