...
class Filter():
    def process(self, df_data, exclude_values=None, include_values=None, column_filter=None, column_as=None):
...
class LabelEncoder():
    def process(self, df_data, column, new_column):
        #df_data = self.parameters['in']
