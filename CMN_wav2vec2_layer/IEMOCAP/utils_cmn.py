...
def loadData(FLAGS):
	...
	if FLAGS.mode == "textaudio":
		...
		text_trainQueries = text_trainQueries
		text_valQueries = text_valQueries
		text_testQueries = text_testQueries
		audio_trainQueries = audio_trainQueries
		audio_valQueries = audio_valQueries
		audio_testQueries = audio_testQueries
	...
	return trainQueries, trainOwnHistory, trainOtherHistory, trainOwnHistoryMask, trainOtherHistoryMask, trainLabels, text_trainQueries, audio_trainQueries, \
			...
			testQueries, testOwnHistory, testOtherHistory, testOwnHistoryMask, testOtherHistoryMask, testLabels, text_testQueries, audio_testQueries
